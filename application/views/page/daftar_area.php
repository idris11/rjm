    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
        <div class="container">
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Area</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kode_area" placeholder="Kode Area" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
