    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Daftar Jenis Pembayaran</h3>
        ...
        <div class="box-body">
        <div class="container">
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Pembayaran</button>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="jenis_pembayaran" placeholder="Jenis Pembayaran" class="form-control" type="text">
